...
$categorias = $database->query("select * from carrinho");
...
<body>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel">Adicionar Carrinho</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id='Salvar' class="btn btn-success">Salvar Carrinho</button>
    ...
    <div class="container">
        ...
        <div class="container_listas_users">
            ...
            while ($categoria = $categorias->fetchArray()) {
